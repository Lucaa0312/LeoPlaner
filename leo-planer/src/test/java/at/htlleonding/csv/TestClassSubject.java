...
public class TestClassSubject {
    ...
    public void findAll() {
        ...
        List<ClassSubject> classSubjects = entityManager.createNamedQuery(ClassSubject.QUERY_FIND_ALL, ClassSubject.class)
                .getResultList();
    ...
    public void findAllByClassname() {
        ...
        List<ClassSubject> classSubjects = entityManager.createNamedQuery(ClassSubject.QUERY_FIND_ALL_BY_CLASSNAME, ClassSubject.class)
